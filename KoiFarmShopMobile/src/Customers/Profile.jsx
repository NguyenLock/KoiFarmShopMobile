...
export default function Profile() {
  ...
  const navigateToCertificate = () => navigation.navigate("Certificate");
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: "bold", color: "#470101", marginBottom: 30 },
  button: { backgroundColor: "#4CAF50", paddingVertical: 12, paddingHorizontal: 25, borderRadius: 8, marginVertical: 10, width: "80%", alignItems: "center", elevation: 3 },
